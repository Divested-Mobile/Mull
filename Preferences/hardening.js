...
//BRACE-DISABLED: pref("dom.serviceWorkers.enabled",				false);
...
//BRACE-DISABLED: pref("dom.allow_cut_copy", false);
...
//BRACE-DISABLED: pref("keyword.enabled",					false);
...
//BRACE-DISABLED: pref("svg.disabled", true);
...
//BRACE-DISABLED: pref("pdfjs.disabled",					true);
...
//BRACE-DISABLED: pref("app.update.enabled",                 true);
...
//BRACE-DISABLED: pref("browser.search.suggest.enabled",			false);

// PREF: Disable "Show search suggestions in location bar results"
pref("browser.urlbar.suggest.searches",			false);
// PREF: When using the location bar, don't suggest URLs from browsing history
//BRACE-DISABLED: pref("browser.urlbar.suggest.history",			false);
...
//BRACE-DISABLED: pref("browser.privatebrowsing.autostart",			true);

// PREF: Do not download URLs for the offline cache
// http://kb.mozillazine.org/Browser.cache.offline.enable
//DISABLED: pref("browser.cache.offline.enable",			false);
...
//BRACE-DISABLED: pref("privacy.sanitize.sanitizeOnShutdown",		true);
...
//BRACE-DISABLED: pref("places.history.enabled",				false);

// PREF: Disable disk cache
// http://kb.mozillazine.org/Browser.cache.disk.enable
//BRACE-DISABLED: pref("browser.cache.disk.enable",				false);
...
//BRACE-DISABLED: pref("browser.cache.disk_cache_ssl",			false);

// PREF: Disable download history
// CIS Version 1.2.0 October 21st, 2011 2.5.5
//BRACE-DISABLED: pref("browser.download.manager.retention",			0);

// PREF: Disable password manager
// CIS Version 1.2.0 October 21st, 2011 2.5.2
//BRACE-DISABLED: pref("signon.rememberSignons",				false);
...
//BRACE-DISABLED: pref("network.cookie.lifetimePolicy",			2);
...
//BRACE-DISABLED: pref("browser.urlbar.autocomplete.enabled",		false);
...
//BRACE-DISABLED: pref("security.OCSP.enabled",				1);
